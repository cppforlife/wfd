...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input3923476422910670668, --data-values-file, /tmp/accelerator-options242453655083314982.json, --output-files, /tmp/ytt-output2729810861003701359]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input16799516409454818520, --data-values-file, /tmp/accelerator-options10409828830003702166.json, --output-files, /tmp/ytt-output1709992715227851472]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12444982171626653476, --data-values-file, /tmp/accelerator-options9599871341648118251.json, --output-files, /tmp/ytt-output3250540311259357220]
